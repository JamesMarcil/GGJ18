public static class GameEvents
{
    ...
    public const string COMMAND_QUEUE_PROCESSING_COMMAND = "GameEvents_COMMAND_QUEUE_PROCESSING_COMMAND";
    public const string COMMAND_QUEUE_SUCCESSFULLY_PROCESSED_COMMAND = "GameEvents_COMMAND_QUEUE_SUCCESSFULLY_PROCESSED_COMMAND";
    public const string COMMAND_QUEUE_FAILED_TO_PROCESS_COMMAND = "GameEvents_COMMAND_QUEUE_FAILED_TO_PROCESS_COMMAND";
